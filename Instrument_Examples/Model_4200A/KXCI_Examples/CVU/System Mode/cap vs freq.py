...
Relies on plotly to output a Capacitance vs Frequency graph. 
...
fig = px.scatter(
    ...
    x="Frequency",
    y="Capacitance",
    title="Capacitance-Frequency Sweep of 465 pF Capacitor",
    labels={"Frequency": "F_AB", "Capacitance": "Cp_AB"},
    hover_data=df.columns,
)

# Manually set the y-axis range
fig.update_layout(yaxis=dict(range=[100e-12, 900e-12]))

# Add line trace
fig.add_trace(px.line(df, x="Frequency", y="Capacitance").data[0])
fig.show()
