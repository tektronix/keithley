"""
This example performs a C-V sweep on a diode using the
...
# Create a DC sweep, from -2 V to 0.4 V in 0.05 V steps, sample z measurements
my4200.query(":CVU:SWEEP:DCV -2, 0.4, 0.05")
...
df.to_csv("cv-diode.csv", index=False)
...
fig = px.scatter(
    ...
    x="Voltage",
    y="Capacitance",
    title="PN Junction Capacitance vs Voltage",
    labels={"Voltage": "DCV_AC", "Capacitance": "Cp_AC"},
