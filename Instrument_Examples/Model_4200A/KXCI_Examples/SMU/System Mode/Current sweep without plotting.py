"""
This example performs a current sweep using the 4200A-SCS in list display mode.
SMU2 sources current from 1 µA to 10 µA in 1 µA steps, while SMU1 holds constant current.
...
# Channel 1. Voltage Name = V1, Current Name = I1, Current Source Mode, Constant Source Function
my4200.query("CH1, 'V1', 'I1', 2, 3")
# Channel 2. Voltage Name = V2, Current Name = I2, Current Source Mode, VAR1 sweep source function
my4200.query("CH2, 'V2', 'I2', 2, 1")
my4200.query("SS") # Access the source setup page
# Setup VAR1 source function, linear sweep, 1e-9 nA to 10e-9 nA, 1e-9 nA steps, 10 V voltage compliance (SMU2)
my4200.query("IR1, 1e-9, 10e-9, 1e-9, 10")
my4200.query("IC1, 0, 10") # Set a constant 0A bias, 10 V voltage compliance (SMU1)
...
my4200.query("LI 'I1','I2','V1','V2'") # Enable current functions I1 & I2 and voltage functions V1 and V2 in list display mode
...
df.to_csv("current_sweep.csv", index=False)
