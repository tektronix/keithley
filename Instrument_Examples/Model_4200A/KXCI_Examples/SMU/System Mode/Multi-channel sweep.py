...
Relies on plotly to output a Drain Voltage vs Gate Current graph
...
# PLOTLY COMMANDS
# Plot drain voltage vs gate current (V2 vs I1)
fig = px.scatter(
    df,
    x="V2",
    y="I1",
    title="Multi-Channel Sweep: Drain Voltage vs Gate Current",
    labels={"V2": "Drain Voltage (V)", "I1": "Gate Current (A)"},
)
fig.add_trace(px.line(df, x="V2", y="I1").data[0])
fig.show()
