...
instrument_write(power_supply_1, "INST:COM:PARA")  # Use for Parallel Connection, Parallel SCPI Command
instrument_write(power_supply_1, "VOLT 0")  # Initialize to a starting level
instrument_write(power_supply_1, "CURR 3")  # Set the max current limit allowed when channels are connected in parallel
