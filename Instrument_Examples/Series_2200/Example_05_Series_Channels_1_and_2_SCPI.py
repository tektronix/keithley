...
====================================================================================================
    ...
    configuration to achieve higher voltage.
...
power_supply_1 = None
resource_manager, power_supply_1 = instrument_connect(resource_manager, power_supply_1, instrument_resource_string, 20000, 0, 1, 1)

instrument_write(power_supply_1, "*RST")
instrument_write(power_supply_1, "SYST:REM")
instrument_write(power_supply_1, "INST:COM:SER")  # Use for Series Connection, Series SCPI Command
instrument_write(power_supply_1, "VOLT 0")  # Initialize to a starting level
instrument_write(power_supply_1, "CURR 3")  # Set the max current limit allowed when channels are connected in series
...
instrument_write(power_supply_1, "INSTrument:NSELect 1")  # Ensure selection of channel 1
instrument_write(power_supply_1, "OUTP 1")  # Turns output on
set_voltage = 0

# Loop example for reading increased voltage levels with increased current capacity and power output
for i in range(1, 14):
    ...
    set_voltage += 5  # Increment the output level
