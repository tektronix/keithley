...
Module Module1
    ...
    Sub Main()
        ...
        Instrument_Write(my_instrument, "SENS:FUNC 'TEMP'")             ' Set function to temperature
        Instrument_Write(my_instrument, "UNIT:TEMP F")                  ' Set units to Fahrenheit
        Instrument_Write(my_instrument, "TEMP:TC:TYPE K")               ' Set thermocouples to type K
        Instrument_Write(my_instrument, "TEMP:RJUN:RSEL REAL")          ' Set reference junction to external(real) to use the channel 1 sensor

        Instrument_Write(my_instrument, "TRIG:COUN 6")                  ' Set the instrument to trigger 10 times
        Instrument_Write(my_instrument, "SAMP:COUN 10")                 ' Capture 10 readings per trigger, inclusive of the channel 1 sensor to CJC is refreshed
        Instrument_Write(my_instrument, "TRAC:POIN 60")                 ' Size the buffer to capture 60 total readings   
        ...
        Instrument_Write(my_instrument, "TRIG:SOUR TIM")                ' Respond to timer trigger events
        Instrument_Write(my_instrument, "TRIG:TIM 10")                  ' Set the timer delay between trigger events to 10 seconds
