...
instrument_write(s, "FUNC 'FRES',(@101:106)")                       # Set function to 4-wire measurement
instrument_write(s, "FRES:OCOM ON, (@101:106)")                     # Set offset compensation to "on"
instrument_write(s, "FRES:RANG 100, (@101,102)")                    # Set the fixed range at 100 Ω
instrument_write(s, "FRES:RANG 10, (@103,104)")                     # Set the fixed range at 10 Ω
instrument_write(s, "FRES:RANG 1, (@105,106)")                      # Set the fixed range at 1 Ω
instrument_write(s, "ROUT:SCAN:CRE (@101:106)")                     # Setup the scan list
