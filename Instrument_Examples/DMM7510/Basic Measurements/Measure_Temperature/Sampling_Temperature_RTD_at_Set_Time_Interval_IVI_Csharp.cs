...
namespace Sampling_Temperature_RTD_at_Set_Time_Interval
{
    class Sampling_Temperature_RTD_at_Set_Time_Interval
    {
        static void Main(string[] args)
        {
            ...
            system_dmm.Measurement.Configuration.Temperature.TransducerType = KeithleyDMM7510TransducerTypeEnum.KeithleyDMM7510TransducerType4WireRtd;
            system_dmm.Measurement.Configuration.Temperature.RTDType[KeithleyDMM7510TemperatureRTDType2Enum.KeithleyDMM7510TemperatureRTDType2Four] = KeithleyDMM7510TemperatureRTDTypeEnum.KeithleyDMM7510TemperatureRTDTypePT100;
            system_dmm.Measurement.Configuration.OffsetCompensationEnabled[KeithleyDMM7510Function5Enum.KeithleyDMM7510Function5Temperature] = true;
            system_dmm.Measurement.Configuration.Temperature.Unit = KeithleyDMM7510TemperatureUnitEnum.KeithleyDMM7510TemperatureUnitFahrenhet;
