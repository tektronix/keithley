...
measured_bias_current, measured_fwd_voltage = my_smu.diode_test_measure_forward_voltage("smua", source_i_range, bias_i,
                                                                                        source_v_limit, settle_time,
                                                                                        nplc, measure_v_range,
                                                                                        my_smu.SmuOutputState.ON)

print("Measured bias current = {0} A".format(measured_bias_current))
print("Measured forward voltage = {0} V".format(measured_fwd_voltage))
